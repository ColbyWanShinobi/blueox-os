...
set -euo pipefail
################
APP_NAME=MControlCenter
APP_COMMAND=mcontrolcenter
DL_URL='https://github.com/dmitry-s93/MControlCenter/releases/download/0.5.1/MControlCenter-0.5.1-Fedora_42.rpm'
PACKAGE_TYPE=rpm
################
